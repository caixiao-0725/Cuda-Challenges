...
#include "types.h"
#include "cubic.h"
namespace cuccd::autogen {

__device__ __host__ __forceinline__ CubicEquation point_triangle_ccd_equation(
    const real x00,
    const real y00,
    const real z00,
    const real x10,
...
__device__ __host__ __forceinline__ CubicEquation edge_edge_ccd_equation(
    const real x00,
    const real y00,
    const real z00,
    const real x10,
